...
class VueGraphique(Frame):
        ...
        def AfficherJeuUI(self):
                ...
                self.placerEtoile(self.parent.modele.etoiles)

        def placerEtoile(self,etoiles):
                print("ETOILE")
                for etoile in etoiles:
                    self.canevas.create_rectangle(0,0,20,20,fill="green")   
                    self.canevas.create_oval(etoile.x-5,etoile.y-5,etoile.x+5,etoile.y+5,width=20,fill="yellow")
